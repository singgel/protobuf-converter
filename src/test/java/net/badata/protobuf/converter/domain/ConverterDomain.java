...
public class ConverterDomain {
    ...
    public static class Test {
        ...
        public Test protobufToDomain(ConverterProto.ConverterTest protoTest) {
            this.longValue = protoTest.getLongValue();
            this.intValue = protoTest.getIntValue();
            this.floatValue = protoTest.getFloatValue();
            this.doubleValue = protoTest.hasDoubleValue() ? protoTest.getDoubleValue().getValue() : null;
            this.boolValue = protoTest.getBooleanValue();
            this.stringValue = protoTest.getStringValue();
            this.primitiveValue = new PrimitiveTest().protobufToDomain(protoTest.getPrimitiveValue());
            this.fieldConversionValue = new FieldConverterTest().protobufToDomain(protoTest.getFieldConversionValue());
            this.nullDefaultValue = new NullDefaultTest().protobufToDomain(protoTest.getNullDefaultValue());
            this.simpleListValue = protoTest.getStringListValueList();
            this.complexListValue = complexListValue(protoTest.getComplexListValueList());
            this.complexSetValue = complexSetValue(protoTest.getComplexSetValueList());
            this.complexNullableCollectionValue = complexListValue(protoTest.getComplexNullableCollectionValueList());
            this.bytesValue = protoTest.getBytesValue();
            this.recursiveValue = new Test().protobufToDomain(protoTest.getRecursiveValue());
            return this;
        }
    }

    private static List<PrimitiveTest> complexListValue(List<ConverterProto.PrimitiveTest> primitiveTests) {
        List<PrimitiveTest> primitiveTestList = new ArrayList<>(primitiveTests.size());
        for (int i = 0; i < primitiveTests.size(); i++) {
            primitiveTestList.add(new PrimitiveTest().protobufToDomain(primitiveTests.get(i)));
        }
        return primitiveTestList;
    }

    private static Set<PrimitiveTest> complexSetValue(List<ConverterProto.PrimitiveTest> primitiveTests) {
        Set<PrimitiveTest> primitiveTestSet = new HashSet<>(primitiveTests.size());
        for (int i = 0; i < primitiveTests.size(); i++) {
            primitiveTestSet.add(new PrimitiveTest().protobufToDomain(primitiveTests.get(i)));
        }
        return primitiveTestSet;
    }
    ...
    public static class PrimitiveTest {
        ...
        public PrimitiveTest protobufToDomain(ConverterProto.PrimitiveTest protoTest) {
            this.longValue = protoTest.getLongValue();
            this.intValue = protoTest.getIntValue();
            this.floatValue = protoTest.getFloatValue();
            this.doubleValue = protoTest.getDoubleValue();
            this.booleanValue = protoTest.getBooleanValue();
            return this;
        }
    }
    ...
    public static class FieldConverterTest {
        ...
        public FieldConverterTest protobufToDomain(ConverterProto.FieldConverterTest protoTest) {
            this.enumString = TestEnumConverter.TestEnum.ONE;
            this.dateLong = new Date(protoTest.getDateLong());
            this.stringSetValue = new HashSet<>(protoTest.getStringSetValueList());
            return this;
        }
    }
    ...
    public static class NullDefaultTest {
        ...
        public NullDefaultTest protobufToDomain(ConverterProto.NullDefaultTest protoTest) {
            this.nullString = protoTest.getNullString();
            this.customInspectionString = protoTest.getCustomInspectionString();
            this.defaultPrimitives = new PrimitiveWrapperTest().protobufToDomain(protoTest.getDefaultPrimitives());
            return this;
        }
    }
    ...
    public static class PrimitiveWrapperTest {
        ...
        public PrimitiveWrapperTest protobufToDomain(ConverterProto.PrimitiveTest protoTest) {
            this.longValue = protoTest.getLongValue();
            this.intValue = protoTest.getIntValue();
            this.floatValue = protoTest.getFloatValue();
            this.doubleValue = protoTest.getDoubleValue();
